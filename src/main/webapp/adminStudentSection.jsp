...
<head>
    ...
    <style>
        :root {
            ...
            --gradient-timetable: linear-gradient(135deg, #f5e6b3, #fff3cc);
        }
...
<body>
    ...
    <div class="main-container">
        <h1 class="mb-4">Student Section</h1>
        <div class="row justify-content-center">
            <div class="col-md-4 mb-4">
                <div class="option-card enter-card">
                    ...
                    <a href="adminAddStudent.jsp" class="btn btn-custom mt-3">Enter Details</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="option-card view-card">
                    <img src="https://cdn-icons-png.flaticon.com/512/709/709612.png" alt="View Student Icon" class="option-icon">
                    <h3>View Student Details</h3>
                    <a href="adminViewStudent.jsp" class="btn btn-custom mt-3">View Details</a>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="option-card edit-card">
                    <img src="https://cdn-icons-png.flaticon.com/512/2919/2919592.png" alt="Edit Student Icon" class="option-icon">
                    <h3>Edit Student Details</h3>
                    <a href="adminEditStudent.jsp" class="btn btn-custom mt-3">Edit Details</a>
                </div>
            </div>
            <div class="col-md-8 mb-4">
                <div class="option-card timetable-card">
                    <img src="https://img.icons8.com/ios-filled/50/000000/calendar.png" alt="Timetable Icon" class="option-icon">
                    <h3>Student Timetable</h3>
                    <a href="adminTimetable.jsp" class="btn btn-custom mt-3">View Timetable</a>
                </div>
            </div>
        </div>
        <a href="dashboardAdmin.jsp" class="btn btn-back mt-4">Back to Home</a>
    </div>
